        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-md hover:shadow-xl transition-shadow rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <a href="#!" className="text-lg font-semibold text-gray-800 hover:underline">Full Service</a>
            ...
            <div className="bg-white shadow-md hover:shadow-xl transition-shadow rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <a href="#!" className="text-lg font-semibold text-gray-800 hover:underline">Normal Service</a>
                <p className="mt-3 text-gray-600">Our experts are skilled to handle any major mechanical repair. We are armed with the best of tools.</p>
              </div>
            </div>
            ...
            <div className="bg-white shadow-md hover:shadow-xl transition-shadow rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <a href="#!" className="text-lg font-semibold text-gray-800 hover:underline">Request Service History</a>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-md hover:shadow-xl transition-shadow rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <a href="#!" className="text-lg font-semibold text-gray-800 hover:underline">Highly Skilled Technicians</a>
            ...
            <div className="bg-white shadow-md hover:shadow-xl transition-shadow rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <a href="#!" className="text-lg font-semibold text-gray-800 hover:underline">Handled the repairs</a>
            ...
            <div className="bg-white shadow-md hover:shadow-xl transition-shadow rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <a href="#!" className="text-lg font-semibold text-gray-800 hover:underline">Keep all the records</a>
